...
class EntityChangeService
{
    ...
    protected function parseEntity($entity): ?array
    {
        if (!$entity instanceof EntityInterface) {
            throw new \InvalidArgumentException(
                sprintf('Given entity does not implement EntityInterface, %s instead', is_object($entity) ? get_class($entity) : gettype($entity))
            );
        }
    ...
    public function deleteEntity($entity): void
    {
        if (!$entity instanceof EntityInterface) {
            throw new \InvalidArgumentException(
                sprintf('Given entity is not an object, %s instead', gettype($entity))
            );
        }
